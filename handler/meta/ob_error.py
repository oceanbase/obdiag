...
OB_RET_DICT = {
    ...
    "-4005": [
        "OB_INIT_TWICE",
        "The object is initialized twice",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4006": [
    ...
    "-4007": [
        "OB_NOT_SUPPORTED",
        "Not supported feature or function. Compatible Error Code: MySQL: 1235(0A000)",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4008": [
    ...
    "-4027": [
        "OB_FILE_NOT_EXIST",
        "File not exist. Compatible Error Code:MySQL: 1017(HY000)",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4028": [
        "OB_DISCONTINUOUS_LOG",
        "Log entry not continuous",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4029": [
    ...
    "-4038": [
        "OB_NOT_MASTER",
        "The observer or zone is not the master",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4039": [
        "OB_KILLED_BY_THROTTLING",
        "Request has killed by sql throttle",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4041": [
    ...
    "-4042": [
        "OB_USER_NOT_EXIST",
        "Can not find any matching row in the user table",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4043": [
    ...
    "-4049": [
        "OB_WAITQUEUE_TIMEOUT",
        "Task timeout and not executed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4050": [
    ...
    "-4053": [
        "OB_NO_CS_SELECTED",
        "No ChunkServer selected",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4054": [
        "OB_NO_TABLETS_CREATED",
        "No tablets created",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-4057": [
        "OB_DECIMAL_OVERFLOW_WARN",
        "Decimal overflow warning",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4058": [
        "OB_DECIMAL_UNLEGAL_ERROR",
    ...
    "-4106": [
        "OB_NOT_ENOUGH_STORE",
        "not enough commitlog store",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4107": [
        "OB_BLOCK_SWITCHED",
        "block switched when fill commitlog",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4109": [
    ...
    "-4115": [
        "OB_UPS_MASTER_EXISTS",
        "Master UpdateServer already exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4116": [
    ...
    "-4126": [
        "OB_INIT_SQL_CONTEXT_ERROR",
        "Init SQL context error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4127": [
    ...
    "-4138": [
        ...
        "Request to read too old versioned data",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4139": [
    ...
    "-4154": [
        "OB_ERR_SQL_CLIENT",
        "Internal SQL client error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4155": [
        "OB_META_TABLE_WITHOUT_USE_TABLE",
        "Meta table without use table",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4156": [
    ...
    "-4159": [
        "OB_POOL_REGISTERED_FAILED",
        "register pool failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4160": [
        "OB_POOL_UNREGISTERED_FAILED",
        "unregister pool failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4161": [
    ...
    "-4162": [
        "OB_LEASE_NOT_ENOUGH",
        "reserved lease not enough",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4163": [
        "OB_LEASE_NOT_MATCH",
        "ups lease not match with rs",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4164": [
        "OB_UPS_SWITCH_NOT_HAPPEN",
        "ups switch not happen",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4165": [
    ...
    "-4167": [
        ...
        "Nested loop not support",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4168": [
        "OB_LOG_INVALID_MOD_ID",
        "Invalid log module id",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4169": [
        "OB_LOG_MODULE_UNKNOWN",
        "Unknown module name",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4170": [
        "OB_LOG_LEVEL_INVALID",
        "Invalid level",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4171": [
        "OB_LOG_PARSER_SYNTAX_ERR",
        "Syntax to set log_level error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4172": [
        "OB_INDEX_OUT_OF_RANGE",
        "Index out of range",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-4176": [
        "OB_CACHE_SHRINK_FAILED",
        "shrink cache failed, no available cache",
        "Internal Error",
    ],
    "-4177": [
    ...
    "-4178": [
        "OB_RELEASE_SCHEMA_ERROR",
        "Release schema error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4179": [
    ...
    "-4184": [
        ...
        "ChunkServer out of disk space",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4185": [
        "OB_COLUMN_GROUP_NOT_FOUND",
    ...
    "-4186": [
        ...
        "ChunkServer failed to get compress library",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4187": [
    ...
    "-4188": [
        "OB_SCHEDULER_TASK_CNT_MISMATCH",
        "Running task cnt and unfinished task cnt not consistent",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4189": [
        "OB_INVALID_MACRO_BLOCK_TYPE",
        "the macro block type does not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4190": [
    ...
    "-4200": [
        "OB_HASH_EXIST",
        "hash map/set entry exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4201": [
        "OB_HASH_NOT_EXIST",
        "hash map/set entry not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4204": [
        "OB_HASH_GET_TIMEOUT",
        "hash map/set get timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4205": [
        "OB_HASH_PLACEMENT_RETRY",
        "hash map/set retry",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-4208": [
        "OB_WAIT_NEXT_TIMEOUT",
        "wait next packet timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4209": [
        "OB_LEADER_NOT_EXIST",
        "partition has not leader",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4210": [
        "OB_PREPARE_MAJOR_FREEZE_FAILED",
        "prepare major freeze failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4211": [
        "OB_COMMIT_MAJOR_FREEZE_FAILED",
        "commit major freeze failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4212": [
        "OB_ABORT_MAJOR_FREEZE_FAILED",
        "abort major freeze failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4213": [
        "OB_MAJOR_FREEZE_NOT_FINISHED",
        "last major freeze not finish",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4214": [
        "OB_PARTITION_NOT_LEADER",
        "partition is not leader partition",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4215": [
        "OB_WAIT_MAJOR_FREEZE_RESPONSE_TIMEOUT",
        "wait major freeze response timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4216": [
    ...
    "-4217": [
        ...
        "Major freeze not allowed now",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4218": [
        "OB_PREPARE_FREEZE_FAILED",
        "prepare freeze failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4219": [
    ...
    "-4220": [
        ...
        "Inactive sql client, only read allowed",
        "Internal Error",
    ],
    "-4221": [
        "OB_INACTIVE_RPC_PROXY",
        "Inactive rpc proxy, can not send RPC request",
        "Internal Error",
    ],
    "-4222": [
        "OB_INTERVAL_WITH_MONTH",
        "Interval with year or month can not be converted to microseconds",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4223": [
        "OB_TOO_MANY_DATETIME_PARTS",
        "Interval has too many datetime parts",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4224": [
    ...
    "-4232": [
        "OB_NOT_FOLLOWER",
        "The observer or zone is not a follower",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4233": [
        "OB_ERR_OUT_OF_LOWER_BOUND",
        "smaller than container lower bound",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4234": [
        "OB_ERR_OUT_OF_UPPER_BOUND",
        "bigger than container upper bound",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4236": [
        "OB_OBCONFIG_RETURN_ERROR",
        "ObConfig return error code",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4237": [
        "OB_OBCONFIG_APPNAME_MISMATCH",
        "Appname mismatch with obconfig result",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4238": [
    ...
    "-4239": [
        "OB_CANT_MJ_PATH",
        "Can not use merge-join to join the tables without join conditions",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4240": [
        "OB_ERR_NO_JOIN_ORDER_GENERATED",
        "No join order generated",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4241": [
        "OB_ERR_NO_PATH_GENERATED",
        "No join path generated",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4242": [
    ...
    "-4244": [
        ...
        "Timer task has been scheduled",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4245": [
        "OB_TIMER_TASK_HAS_NOT_SCHEDULED",
        "Timer task has not been scheduled",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4246": [
        "OB_PARSE_DEBUG_SYNC_ERROR",
        "parse debug sync string error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4247": [
        "OB_UNKNOWN_DEBUG_SYNC_POINT",
        "unknown debug sync point",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4248": [
        "OB_ERR_INTERRUPTED",
        "task is interrupted while running",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4249": [
        "OB_ERR_DATA_TRUNCATED",
        "Data truncated for argument",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4250": [
    ...
    "-4252": [
        "OB_ERR_TIMEOUT_TRUNCATED",
        "Timeout value truncated to 102 years",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4254": [
        "OB_ERR_NET_PACKET_TOO_LARGE",
        "Got a packet bigger than 'max_allowed_packet' bytes",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4255": [
        "OB_TRACE_DESC_NOT_EXIST",
        "trace log title or key not exist describle",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4256": [
    ...
    "-4257": [
        ...
        "compress data or decompress data failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4258": [
    ...
    "-4260": [
        "OB_IS_CHANGING_LEADER",
        "the partition is changing leader",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4261": [
        "OB_DATETIME_FUNCTION_OVERFLOW",
        "Datetime overflow",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4262": [
        "OB_ERR_DOUBLE_TRUNCATED",
    ...
    "-4263": [
        ...
        "Minor freeze not allowed now",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4264": [
        "OB_LOG_OUTOF_DISK_SPACE",
        "Log out of disk space",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4265": [
    ...
    "-4266": [
        "OB_MINOR_MERGE_NOT_ALLOW",
        "minor merge not allow",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4267": [
    ...
    "-4268": [
        ...
        "reach server data copy in concurrency",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4269": [
        "OB_WORKING_PARTITION_EXIST",
        "Working partition entry already exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4270": [
        "OB_WORKING_PARTITION_NOT_EXIST",
        "Working partition entry does not exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4271": [
        "OB_LIBEASY_REACH_MEM_LIMIT",
        "LIBEASY reach memory limit",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4272": ["OB_MISS_ARGUMENT", "Miss argument", "Miss argument", "Internal Error"],
    "-4273": [
        "OB_CACHE_FREE_BLOCK_NOT_ENOUGH",
    ...
    "-4274": [
        ...
        "sync wash memblock timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4275": [
        "OB_NOT_ALLOW_MIGRATE_IN",
        "not allow migrate in",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4276": [
        "OB_SCHEDULER_TASK_CNT_MISTACH",
        "Scheduler task cnt does not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4277": [
    ...
    "-4278": [
        "OB_LAST_LOG_NOT_COMPLETE",
        "last log is not complete",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4279": [
    ...
    "-4280": [
        "OB_VERSION_RANGE_NOT_CONTINUES",
        "version range not continues",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4281": [
        "OB_INVALID_IO_BUFFER",
        "io buffer is invalid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4282": [
        "OB_PARTITION_IS_REMOVED",
    ...
    "-4284": [
        ...
        "major sstable not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4285": [
        "OB_VERSION_RANGE_DISCARDED",
        "Request to read too old version range data",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4286": [
        "OB_MAJOR_SSTABLE_HAS_MERGED",
        "major sstable may has been merged",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4287": [
        "OB_MINOR_SSTABLE_RANGE_CROSS",
        "minor sstable version range cross",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4288": [
    ...
    "-4292": [
        "OB_CANT_INITIALIZE_UDF",
        "Can't initialize function",
        "Can not initialize function ",
        "Internal Error",
    ],
    "-4293": [
        "OB_UDF_NO_PATHS",
    ...
    "-4308": [
        "OB_ERR_CONFL_CYCLE_SPEC",
        "conflicting CYCLE/NOCYCLE specifications",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4309": [
        "OB_ERR_CONFL_CACHE_SPEC",
    ...
    "-4311": [
        "OB_ERR_ALTER_START_SEQ_NUMBER_NOT_ALLOWED",
        "cannot alter starting sequence number",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4312": [
        "OB_ERR_DUP_INCREMENT_BY_SPEC",
        "duplicate INCREMENT BY specifications",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4313": [
        "OB_ERR_DUP_START_WITH_SPEC",
    ...
    "-4315": [
        "OB_ERR_SEQ_NOT_ALLOWED_HERE",
        "sequence number not allowed here",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4316": [
        "OB_ERR_SEQ_NOT_EXIST",
        "sequence does not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4317": [
        "OB_ERR_SEQ_OPTION_MUST_BE_INTEGER",
        "sequence parameter must be an integer",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4318": [
        "OB_ERR_SEQ_INCREMENT_CAN_NOT_BE_ZERO",
    ...
    "-4319": [
        ...
        "sequence parameter exceeds maximum size allowed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4320": [
        "OB_ERR_MINVALUE_LARGER_THAN_MAXVALUE",
        "MINVALUE must be less than MAXVALUE",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4321": [
        "OB_ERR_SEQ_INCREMENT_TOO_LARGE",
    ...
    "-4323": [
        "OB_ERR_MINVALUE_EXCEED_CURRVAL",
    ...
    "-4325": [
        "OB_ERR_MAXVALUE_EXCEED_CURRVAL",
        "MAXVALUE cannot be made to be less than the current value",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4326": [
        "OB_ERR_SEQ_CACHE_TOO_SMALL",
        "the number of values to CACHE must be greater than 1",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4327": [
        "OB_ERR_SEQ_OPTION_OUT_OF_RANGE",
        "sequence option value out of range",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4328": [
        "OB_ERR_SEQ_CACHE_TOO_LARGE",
    ...
    "-4332": [
        ...
        "sequence exceeds limit and cannot be instantiated",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4333": [
        "OB_ERR_DIVISOR_IS_ZERO",
    ...
    "-4505": [
        "OB_IMPORT_NOT_IN_SERVER",
        "Import not in service",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4507": [
    ...
    "-4512": [
        "OB_RS_STATE_NOT_ALLOW",
        "RootServer state error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4515": [
    ...
    "-4523": [
        "OB_ZONE_ALREADY_MASTER",
        "The zone is the master already",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4524": [
    ...
    "-4525": [
        "OB_ZONE_IS_NOT_SLAVE",
        "Not slave zone",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4526": [
        "OB_ZONE_IS_NOT_MASTER",
        "Not master zone",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-4528": [
        "OB_IP_PORT_IS_NOT_ZONE",
        "Not a zone address",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4529": [
        "OB_MASTER_ZONE_NOT_EXIST",
        "Master zone not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4530": [
        "OB_ZONE_INFO_NOT_EXIST",
        "Zone info not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4531": [
        "OB_GET_ZONE_MASTER_UPS_FAILED",
        "Failed to get master UpdateServer",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4532": [
        "OB_MULTIPLE_MASTER_ZONES_EXIST",
    ...
    "-4533": [
        ...
        "indexing zone is not exist anymore or not active",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4537": [
        "OB_ROOT_TABLE_RANGE_NOT_EXIST",
        "Tablet range not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4538": [
        "OB_ROOT_MIGRATE_CONCURRENCY_FULL",
        "Migrate concurrency full",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4539": [
        "OB_ROOT_MIGRATE_INFO_NOT_FOUND",
        "Migrate info not found",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4540": [
        "OB_NOT_DATA_LOAD_TABLE",
        "No data to load",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4541": [
        ...
        "Duplicated table data to load",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4542": [
        "OB_ROOT_TABLE_ID_EXIST",
        "Table ID exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-4545": [
        "OB_INDEX_INELIGIBLE",
        "index data not unique",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4546": [
        "OB_REBALANCE_EXEC_TIMEOUT",
        "execute replication or migration task timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4547": [
        "OB_MERGE_NOT_STARTED",
        "global merge not started",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4548": [
        "OB_MERGE_ALREADY_STARTED",
    ...
    "-4549": [
        ...
        "rootservice already exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4550": [
        "OB_RS_SHUTDOWN",
        "rootservice is shutdown",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4551": [
        "OB_SERVER_MIGRATE_IN_DENIED",
        "server migrate in denied",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4552": [
        "OB_REBALANCE_TASK_CANT_EXEC",
        "rebalance task can not executing now",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4553": [
        "OB_PARTITION_CNT_REACH_ROOTSERVER_LIMIT",
        "rootserver can not hold more partition",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4554": [
        "OB_REBALANCE_TASK_NOT_IN_PROGRESS",
        "rebalance task not in progress on observer",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4600": [
        "OB_DATA_SOURCE_NOT_EXIST",
        "Data source not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4601": [
        "OB_DATA_SOURCE_TABLE_NOT_EXIST",
        "Data source table not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4602": [
        "OB_DATA_SOURCE_RANGE_NOT_EXIST",
        "Data source range not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4603": [
        "OB_DATA_SOURCE_DATA_NOT_EXIST",
        "Data source data not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4604": [
        "OB_DATA_SOURCE_SYS_ERROR",
        "Data source sys error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4605": [
        "OB_DATA_SOURCE_TIMEOUT",
        "Data source timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4606": [
        "OB_DATA_SOURCE_CONCURRENCY_FULL",
        "Data source concurrency full",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4607": [
        "OB_DATA_SOURCE_WRONG_URI_FORMAT",
        "Data source wrong URI format",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4608": [
        "OB_SSTABLE_VERSION_UNEQUAL",
        "SSTable version not equal",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4609": [
        "OB_UPS_RENEW_LEASE_NOT_ALLOWED",
        "ups should not renew its lease",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4610": [
    ...
    "-4611": [
        "OB_NO_UPS_MAJORITY",
        "ups not form a majority",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4613": [
        "OB_INDEX_COUNT_REACH_THE_LIMIT",
        "created index tables count has reach the limit:128",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4614": [
    ...
    "-4615": [
        "OB_TABLEGROUP_NOT_EMPTY",
        "tablegroup is not empty",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4620": [
        "OB_INVALID_SERVER_STATUS",
        "server status is not valid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4621": [
        "OB_WAIT_ELEC_LEADER_TIMEOUT",
        "wait elect partition leader timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4622": [
        "OB_WAIT_ALL_RS_ONLINE_TIMEOUT",
        "wait all rs online timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4623": [
        "OB_ALL_REPLICAS_ON_MERGE_ZONE",
        "all replicas of partition group are on zones to merge",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4624": [
    ...
    "-4625": [
        "OB_NOT_SERVER_CAN_HOLD_SOFTLY",
        "not server can hole the unit and not over soft limit",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4626": [
        "OB_RESOURCE_POOL_ALREADY_GRANTED",
        "resource pool has already been granted to a tenant",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4628": [
        "OB_SERVER_ALREADY_DELETED",
    ...
    "-4629": [
        ...
        "server is not in deleting status",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4630": [
        "OB_SERVER_NOT_IN_WHITE_LIST",
        "server not in server white list",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4631": [
        "OB_SERVER_ZONE_NOT_MATCH",
        "server zone not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4632": [
        "OB_OVER_ZONE_NUM_LIMIT",
        "zone num has reach max zone num",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4633": [
        "OB_ZONE_STATUS_NOT_MATCH",
        "zone status not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4634": [
        "OB_RESOURCE_UNIT_IS_REFERENCED",
        "resource unit is referenced by resource pool",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4636": [
    ...
    "-4638": [
        "OB_RS_NOT_MASTER",
        "The RootServer is not the master",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4639": [
        "OB_CANDIDATE_LIST_ERROR",
        "The candidate list is invalid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4640": [
        "OB_PARTITION_ZONE_DUPLICATED",
        "The chosen partition servers belong to same zone.",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4641": [
        "OB_ZONE_DUPLICATED",
        "Duplicated zone in zone list",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4642": [
        "OB_NOT_ALL_ZONE_ACTIVE",
        "Not all zone in zone list are active",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4643": [
        "OB_PRIMARY_ZONE_NOT_IN_ZONE_LIST",
        "primary zone not in zone list",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4644": [
        "OB_REPLICA_NUM_NOT_MATCH",
        "replica num not same with zone count",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4645": [
        "OB_ZONE_LIST_POOL_LIST_NOT_MATCH",
        "zone list not a subset of  resource pool list",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4646": [
        "OB_INVALID_TENANT_NAME",
        "tenant name is too long",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4647": [
        "OB_EMPTY_RESOURCE_POOL_LIST",
        "resource pool list is empty",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4648": [
        "OB_RESOURCE_UNIT_NOT_EXIST",
        "resource unit not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4649": [
        "OB_RESOURCE_UNIT_EXIST",
        "resource unit already exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4650": [
        "OB_RESOURCE_POOL_NOT_EXIST",
    ...
    "-4651": [
        ...
        "resource pool already exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4652": [
        "OB_WAIT_LEADER_SWITCH_TIMEOUT",
        "wait leader switch timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4653": [
    ...
    "-4656": [
        "OB_UNIT_NUM_OVER_SERVER_COUNT",
        "resource pool unit num is bigger than zone server count",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4657": [
        "OB_POOL_SERVER_INTERSECT",
        "resource pool list unit server intersect",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4658": [
        "OB_NOT_SINGLE_RESOURCE_POOL",
        "create tenant only support single resource pool now",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4659": [
        "OB_INVALID_RESOURCE_UNIT",
        "invalid resource unit",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4660": [
        "OB_STOP_SERVER_IN_MULTIPLE_ZONES",
        "Can not stop server in multiple zones",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4661": [
    ...
    "-4664": [
        "OB_GET_LOCATION_TIME_OUT",
        "Timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4665": [
        "OB_UNIT_IS_MIGRATING",
        "Unit is migrating can not migrate again",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4666": [
        "OB_CLUSTER_NO_MATCH",
        "cluster name is not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4667": [
        "OB_CHECK_ZONE_MERGE_ORDER",
        "Please check new zone in zone_merge_order. You can show parameters like 'zone_merge_order'",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4668": [
        "OB_ERR_ZONE_NOT_EMPTY",
        "zone not empty",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-4671": [
        "OB_FULL_REPLICA_NUM_NOT_ENOUGH",
        "full replica num not enough",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4672": [
        "OB_REPLICA_NUM_NOT_ENOUGH",
        "replica num not enough",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4673": [
        "OB_DATA_SOURCE_NOT_VALID",
        "Data source not valid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4674": [
        "OB_RUN_JOB_NOT_SUCCESS",
        "run job not success yet",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4675": [
    ...
    "-4681": [
        "OB_RPC_NEED_RECONNECT",
        "rpc need reconnect",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4682": [
        "OB_CANNOT_COPY_MAJOR_SSTABLE",
        "cannot copy major sstable now",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4683": [
        "OB_SRC_DO_NOT_ALLOWED_MIGRATE",
        "src do not allowed migrate",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4684": [
        "OB_TOO_MANY_TENANT_PARTITIONS_ERROR",
        "Too many partitions were defined for this tenant",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-4685": [
        "OB_ACTIVE_MEMTBALE_NOT_EXSIT",
        "active memtable not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5000": [
        "OB_ERR_PARSER_INIT",
        "Failed to init SQL parser",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5001": [
    ...
    "-5006": [
        ...
        "You have an error in your SQL syntax; check the manual that corresponds to your OceanBase version for the right syntax to use",
        "Internal Error",
    ...
    "-5010": [
        "OB_ERR_OPERATOR_UNKNOWN",
        "Unknown operator",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5011": [
        "OB_ERR_STAR_DUPLICATE",
        "Duplicated star",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5014": [
        "OB_ERR_ILLEGAL_VALUE",
        "Illegal value",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5015": [
        "OB_ERR_COLUMN_AMBIGUOUS",
        "Ambiguous column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5023": [
        ...
        "Illegal type",
        "Internal Error",
        "Maybe you should use java.sql.Timestamp instead of java.util.Date.",
    ],
    "-5024": [
    ...
    "-5026": [
        ...
        "Duplicated createtime",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5027": [
        "OB_ERR_MODIFYTIME_DUPLICATE",
        "Duplicated modifytime",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5028": [
        "OB_ERR_ILLEGAL_INDEX",
        "Illegal index",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5029": [
        "OB_ERR_INVALID_SCHEMA",
        "Invalid schema",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5031": [
        "OB_ERR_COLUMN_NOT_FOUND",
        "Column not found",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5032": [
        "OB_ERR_DELETE_NULL_ROWKEY",
        "Delete null rowkey",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5040": [
        ...
        "Can not update rowkey column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5041": [
        "OB_ERR_UPDATE_JOIN_COLUMN",
        "Can not update join column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5043": [
        "OB_ERR_PREPARE_STMT_NOT_FOUND",
    ...
    "-5051": [
        "OB_ERR_PASSWORD_EMPTY",
        "Empty password",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5052": [
        "OB_ERR_GRANT_PRIVILEGES_TO_CREATE_TABLE",
        "Failed to grant privelege",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5053": [
        "OB_ERR_WRONG_DYNAMIC_PARAM",
        "Wrong dynamic parameters",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5054": [
    ...
    "-5056": [
        ...
        "CreateTime or ModifyTime column cannot be modified",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5057": [
        "OB_ERR_MODIFY_PRIMARY_KEY",
        "Primary key cannot be modified",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5058": [
        "OB_ERR_PARAM_DUPLICATE",
    ...
    "-5066": [
        ...
        "OceanBase instance terminated. Disconnection forced",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5067": [
        "OB_ERR_UNKNOWN_SESSION_ID",
        "Unknown session ID",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5068": [
        "OB_ERR_PROTOCOL_NOT_RECOGNIZE",
        "Incorrect protocol",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5071": [
        "OB_ERR_ALTER_INDEX_COLUMN",
        "Cannot alter index column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5072": [
        "OB_ERR_MODIFY_INDEX_TABLE",
        "Cannot modify index table",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5073": [
        "OB_ERR_INDEX_UNAVAILABLE",
        "Index unavailable",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5074": [
        "OB_ERR_NOP_VALUE",
        "NOP cannot be used here",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5080": [
        "OB_ERR_PS_TOO_MANY_PARAM",
    ...
    "-5081": [
        "OB_ERR_READ_ONLY",
        "The server is read only now",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5083": [
        "OB_ERR_INVALID_TYPE_FOR_OP",
        "Invalid data type for the operation",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5084": [
        "OB_ERR_CAST_VARCHAR_TO_BOOL",
        "Can not cast varchar value to bool type",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5085": [
        "OB_ERR_CAST_VARCHAR_TO_NUMBER",
        "Not a number Can not cast varchar value to number type",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5086": [
        "OB_ERR_CAST_VARCHAR_TO_TIME",
        "Not timestamp Can not cast varchar value to timestamp type",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5087": [
        "OB_ERR_CAST_NUMBER_OVERFLOW",
        "Result value was out of range when cast to number",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5090": [
        "OB_SCHEMA_NUMBER_PRECISION_OVERFLOW",
        "Precision was out of range",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5091": [
        "OB_SCHEMA_NUMBER_SCALE_OVERFLOW",
        "Scale value was out of range",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5092": [
    ...
    "-5103": [
        ...
        "incorrect global or local variable",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5107": [
        "OB_INVALID_ARGUMENT_FOR_IS",
        "Invalid argument for IS operator",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5112": [
    ...
    "-5116": [
        ...
        "Logical operator child index overflow",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5117": [
        "OB_SQL_EXPLAIN_FAILED",
    ...
    "-5120": [
        ...
        "fail to create raw expr",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5121": [
        "OB_SQL_OPT_JOIN_ORDER_FAILED",
        "fail to generate join order",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5122": [
        "OB_SQL_OPT_ERROR",
        "optimizer general error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5130": [
        "OB_SQL_RESOLVER_NO_MEMORY",
        "sql resolver no memory",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5131": [
        "OB_SQL_DML_ONLY",
        "plan cache support dml only",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5133": [
        "OB_ERR_NO_GRANT",
        "No such grant defined",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5134": [
    ...
    "-5135": [
        "OB_SQL_PC_OVERFLOW",
        "plan cache is overflow",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5136": [
        "OB_SQL_PC_PLAN_DUPLICATE",
        "plan exists in plan cache already",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5137": [
        "OB_SQL_PC_PLAN_EXPIRE",
        "plan is expired",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5139": [
        "OB_SQL_PARAMS_LIMIT",
        "too many params plan cache not support",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5140": [
        "OB_SQL_PC_PLAN_SIZE_LIMIT",
        "plan is too big to add to plan cache",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5142": [
        "OB_ERR_UNKNOWN_CHARSET",
    ...
    "-5144": [
        ...
        "The collation is not valid for the character set",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5145": [
        "OB_ERR_WRONG_VALUE_FOR_VAR",
        "Variable can't be set to the value",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5146": [
        "OB_UNKNOWN_PARTITION",
        "Unknown partition",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5149": [
        "OB_ERR_INSERT_INNER_JOIN_COLUMN",
        "Insert inner join column error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5150": [
        "OB_TENANT_NOT_IN_SERVER",
        "Tenant not in this server",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5151": [
        "OB_TABLEGROUP_NOT_EXIST",
    ...
    "-5159": [
        "OB_TABLEGROUP_EXIST",
        "tablegroup already exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5160": [
        "OB_ERR_INVALID_TENANT_NAME",
        "invalid tenant name specified in connection string",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5161": [
    ...
    "-5166": [
        "OB_ERR_DB_DROP_EXISTS",
        "Can't drop database;database doesn't exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5167": [
        "OB_ERR_DATA_TOO_LONG",
        "Data too long for column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5168": [
        "OB_ERR_WRONG_VALUE_COUNT_ON_ROW",
    ...
    "-5184": [
        "OB_ERR_REACH_AUTOINC_MAX",
        "Failed to read auto-increment value from storage engine",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5185": [
        "OB_ERR_NO_TABLES_USED",
        "No tables used",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5187": [
        "OB_CANT_REMOVE_ALL_FIELDS",
    ...
    "-5202": [
        ...
        "Too big scale specified for column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5203": [
        "OB_ERR_TOO_BIG_PRECISION",
        "Too big precision specified for column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5206": [
        "OB_WRONG_GROUP_FIELD",
        "Can't group on column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5207": [
    ...
    "-5210": [
        "OB_ERR_MULTIPLE_PRI_KEY",
        "Multiple primary key defined",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5211": [
        "OB_ERR_KEY_COLUMN_DOES_NOT_EXITS",
        "Key column doesn't exist in table",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5212": [
        "OB_ERR_AUTO_PARTITION_KEY",
        "auto-increment column should not be part of partition key",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5213": [
        "OB_ERR_CANT_USE_OPTION_HERE",
        "Incorrect usage/placement",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5214": [
    ...
    "-5215": [
        "OB_ERR_ON_RENAME",
        "Error on rename table",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5216": [
        "OB_ERR_WRONG_KEY_COLUMN",
    ...
    "-5220": [
        "OB_ERR_CANT_EXECUTE_IN_READ_ONLY_TRANSACTION",
    ...
    "-5224": [
        "OB_WRONG_NAME_FOR_INDEX",
        "Incorrect index name",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5226": [
        "OB_REACH_MEMORY_LIMIT",
        "plan cache memory used reach the high water mark.",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5228": [
        "OB_ERR_NON_UPDATABLE_TABLE",
        "The target table is not updatable",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5229": [
        "OB_ERR_WARN_DATA_OUT_OF_RANGE",
        "Out of range value for column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5234": [
        "OB_ERR_DB_READ_ONLY",
        "The database is read only so it cannot execute this statement",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5235": [
        "OB_ERR_TABLE_READ_ONLY",
        "The table is read only so it cannot execute this statement",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5236": [
        "OB_ERR_LOCK_OR_ACTIVE_TRANSACTION",
    ...
    "-5239": [
        "OB_ERR_VIEW_RECURSIVE",
        "view contains recursion",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5240": [
    ...
    "-5243": [
        ...
        "system variables' version maybe different",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5244": [
        "OB_ERR_AUTO_INCREMENT_CONFLICT",
    ...
    "-5246": [
        "OB_ERR_NAME_BECOMES_EMPTY",
        "Name has become ''",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5247": [
        "OB_ERR_REMOVED_SPACES",
        "Leading spaces are removed from name ",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5248": [
        "OB_WARN_ADD_AUTOINCREMENT_COLUMN",
        "Alter table add auto_increment column is dangerous",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5249": [
        "OB_WARN_CHAMGE_NULL_ATTRIBUTE",
        "Alter table change nullable column to not nullable is dangerous",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5250": [
    ...
    "-5257": [
        "OB_ERR_PARTITION_FUNC_NOT_ALLOWED_ERROR",
        "The PARTITION function returns the wrong type",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5258": [
        "OB_ERR_INVALID_BLOCK_SIZE",
        "Invalid block size,  block size should between 16384 and 1048576",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5259": [
        "OB_ERR_UNKNOWN_STORAGE_ENGINE",
        "Unknown storage engine",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5260": [
        "OB_ERR_TENANT_IS_LOCKED",
        "Tenant is locked",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5262": [
        "OB_ERR_PARTITION_FUNCTION_IS_NOT_ALLOWED",
        "This partition function is not allowed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5263": [
        "OB_ERR_AGGREGATE_ORDER_FOR_UNION",
        "aggregate order for union",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5264": [
        "OB_ERR_OUTLINE_EXIST",
        "Outline exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5265": [
        "OB_OUTLINE_NOT_EXIST",
        "Outline not exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5266": [
        ...
        "The value should be no less than the limit",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5267": [
    ...
    "-5268": [
        ...
        "SQL reach max concurrent num",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5269": [
        "OB_ERR_OPERATION_ON_RECYCLE_OBJECT",
        "can not perform DDL/DML over objects in Recycle Bin",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5270": [
        "OB_ERR_OBJECT_NOT_IN_RECYCLEBIN",
        "object not in RECYCLE BIN",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5271": [
        "OB_ERR_CON_COUNT_ERROR",
    ...
    "-5272": [
        ...
        "Outline content already exists when added",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5273": [
        "OB_ERR_OUTLINE_MAX_CONCURRENT_EXIST",
        "Max concurrent already exists when added",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5274": [
    ...
    "-5278": [
        "OB_ERR_PARTITION_VALUE_ERROR",
        "This partition value with incorrect charset type",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5279": [
        "OB_ERR_PARTITION_INTERVAL_ERROR",
        "Partition interval must have type INT",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5280": [
    ...
    "-5281": [
        "OB_ERR_RANGE_NOT_INCREASING_ERROR",
    ...
    "-5283": [
        "OB_ERR_UNIQUE_KEY_NEED_ALL_FIELDS_IN_PF",
    ...
    "-5287": [
        "OB_ERR_TOO_MANY_PARTITION_FUNC_FIELDS",
        "Too many fields in 'list of partition fields'",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5288": [
        "OB_ERR_BAD_FT_COLUMN",
        "Column cannot be part of FULLTEXT index",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5289": [
        "OB_ERR_KEY_DOES_NOT_EXISTS",
    ...
    "-5290": [
        ...
        "non-default value for generated column is not allowed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5291": [
        "OB_ERR_BAD_CTXCAT_COLUMN",
        "The CTXCAT column must be contiguous in the index column list",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5292": [
        "OB_ERR_UNSUPPORTED_ACTION_ON_GENERATED_COLUMN",
        "not supported for generated columns",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5293": [
        "OB_ERR_DEPENDENT_BY_GENERATED_COLUMN",
        "Column has a generated column dependency",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5294": [
        "OB_ERR_TOO_MANY_ROWS",
    ...
    "-5296": [
        "OB_NO_READABLE_REPLICA",
        "there has no readable replica",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5297": [
        "OB_ERR_UNEXPECTED_TZ_TRANSITION",
        "unexpected time zone info transition",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5298": [
        "OB_ERR_SYNONYM_EXIST",
        "synonym exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5299": [
        "OB_SYNONYM_NOT_EXIST",
        "synonym not exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5303": [
        ...
        "Error in list of partitions",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5304": [
        "OB_ERR_PARTITION_MGMT_ON_TWOPART_TABLE",
        "Partition management on a two-part table is not possible",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5305": [
        "OB_ERR_ONLY_ON_RANGE_LIST_PARTITION",
        "can only be used on RANGE/LIST partitions",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5306": [
        "OB_ERR_DROP_LAST_PARTITION",
        "Cannot remove all partitions,  use DROP TABLE instead",
        "Internal Error",
    ],
    "-5307": [
        "OB_ERR_SCHEDULER_THREAD_NOT_ENOUGH",
        "Scheduler thread number is not enough",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5308": [
        "OB_ERR_IGNORE_USER_HOST_NAME",
        "Ignore the host name",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5309": [
        "OB_IGNORE_SQL_IN_RESTORE",
        "Ignore sql in restore process",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5310": [
        "OB_ERR_TEMPORARY_TABLE_WITH_PARTITION",
    ...
    "-5314": [
        "OB_ERR_ROW_IS_REFERENCED",
        "Cannot delete or update a parent row: a foreign key constraint fails",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5315": [
        "OB_ERR_NO_REFERENCED_ROW",
        "Cannot add or update a child row: a foreign key constraint fails",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5317": [
        "OB_ERR_CANNOT_ADD_FOREIGN",
    ...
    "-5319": [
        ...
        "Invalid child column length",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5320": [
        "OB_ERR_ALTER_COLUMN_FK",
        "Cannot alter foreign key column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5321": [
        "OB_ERR_CONNECT_BY_REQUIRED",
    ...
    "-5325": [
        "OB_ERR_INVALID_SIBLINGS",
        "ORDER SIBLINGS BY clause not allowed here",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5326": [
        "OB_ERR_INVALID_SEPARATOR",
        "when using SYS_CONNECT_BY_PATH function,  cannot have separator as part of column value",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5327": [
        "OB_ERR_INVALID_SYNONYM_NAME",
        "Database can not be specified in public synonym",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5328": [
        "OB_ERR_LOOP_OF_SYNONYM",
        "Looping chain of synonyms",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5329": [
        "OB_ERR_SYNONYM_SAME_AS_OBJECT",
        "Cannot create a synonym with same name as object",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5330": [
        "OB_ERR_SYNONYM_TRANSLATION_INVALID",
    ...
    "-5333": [
        ...
        "Too long enumeration/set value for column.",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5334": [
        "OB_ER_DUPLICATED_VALUE_IN_TYPE",
        "Column has duplicated value",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5335": [
        "OB_ER_TOO_BIG_ENUM",
        "Too many enumeration values for column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5336": [
        "OB_ERR_TOO_BIG_SET",
        "Too many strings for column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5337": [
    ...
    "-5338": [
        "OB_ERR_INVALID_WINDOW_FUNCTION_PLACE",
        "Window Function not allowed here",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5339": [
        "OB_ERR_PARSE_PARTITION_LIST",
        "Fail to parse list partition",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5340": [
    ...
    "-5341": [
        "OB_ERR_INVALID_TIMEZONE_REGION_ID",
        "timezone region ID is invalid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5342": [
        "OB_ERR_INVALID_HEX_NUMBER",
        "invalid hex number",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5343": [
        "OB_ERR_WRONG_FUNC_ARGUMENTS_TYPE",
        "wrong number or types of arguments in function",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5344": [
        "OB_ERR_MULTI_UPDATE_KEY_CONFLICT",
        "Primary key/partition key update is not allowed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5345": [
        "OB_ERR_INSUFFICIENT_PX_WORKER",
        "insufficient parallel query worker available",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5346": [
        "OB_ERR_FOR_UPDATE_EXPR_NOT_ALLOWED",
    ...
    "-5348": [
        "OB_ERR_TOO_LONG_STRING_IN_CONCAT",
    ...
    "-5541": [
        ...
        "procedure/function already exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5542": [
        "OB_ERR_SP_DOES_NOT_EXIST",
        "procedure/function does not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5543": [
        "OB_ERR_SP_UNDECLARED_VAR",
        "Undeclared variable",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5545": [
        "OB_ERR_SP_COND_MISMATCH",
        "Undefined CONDITION",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5546": [
        "OB_ERR_SP_LILABEL_MISMATCH",
        "no matching label",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5547": [
        "OB_ERR_SP_CURSOR_MISMATCH",
        "Undefined CURSOR",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5556": [
        "OB_ERR_SP_UNHANDLED_EXCEPTION",
        "Unhandled exception has occurred in PL",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5557": [
        "OB_ERR_SP_BAD_CONDITION_TYPE",
    ...
    "-5560": [
        "OB_EER_UNKNOWN_STMT_HANDLER",
        "Unknown prepared statement handle",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5561": [
        "OB_ERR_INVALID_WINDOW_FUNC_USE",
        "Invalid use of window function",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5563": [
        "OB_ERR_CONTRAINT_NOT_FOUND",
    ...
    "-5569": [
        ...
        "stmt is not allowed in stored function",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5570": [
        "OB_ER_SP_NO_RECURSION",
        "Recursive stored functions are not allowed.",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5571": [
        "OB_ER_SP_CASE_NOT_FOUND",
    ...
    "-5577": [
        "OB_PC_GET_LOCATION_ERROR",
        "Plan cache get location failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5578": [
        "OB_PC_LOCK_CONFLICT",
        "Plan cache lock conflict",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5579": [
        "OB_ER_SP_NO_RETSET",
        "Not allowed to return a result set in pl function",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5580": [
        "OB_ER_SP_NORETURNEND",
        "FUNCTION ended without RETURN",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5581": [
        "OB_ERR_SP_DUP_HANDLER",
    ...
    "-5592": [
        "OB_ER_SP_NOT_VAR_ARG",
        "OUT or INOUT argument for routine is not a variable",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5593": [
        "OB_ER_SP_LILABEL_MISMATCH",
    ...
    "-5597": [
        "OB_ERR_SPLIT_LIST_LESS_VALUE",
        "last resulting partition cannot contain bounds",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5598": [
        "OB_ERR_ADD_PARTITION_TO_DEFAULT_LIST",
        "cannot add partition when DEFAULT partition exists",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5599": [
        "OB_ERR_SPLIT_INTO_ONE_PARTITION",
        "cannot split partition into one partition,  use rename instead",
        "Internal Error",
    ],
    "-5600": [
        "OB_ERR_NO_TENANT_PRIVILEGE",
        "can not create user in sys tenant",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5601": [
        "OB_ERR_INVALID_PERCENTAGE",
        "Percentage should between 1 and 99",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5602": [
        "OB_ERR_COLLECT_HISTOGRAM",
        "Should collect histogram after major freeze",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5603": [
        "OB_ER_TEMP_TABLE_IN_USE",
        "Attempt to create,  alter or drop an index on temporary table already in use",
        "Internal Error",
    ],
    "-5604": [
        "OB_ERR_INVALID_NLS_PARAMETER_STRING",
    ...
    "-5606": [
        "OB_ERR_INVALID_NUMBER_FORMAT_MODEL",
        "Invalid number format model",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5607": [
        "OB_ERR_CMD_NOT_PROPERLY_ENDED",
    ...
    "-5617": [
        "OB_INAPPROPRIATE_INTO",
        "inappropriate INTO",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5618": [
        "OB_ERR_TABLE_IS_REFERENCED",
        "Cannot delete or update a parent row: a foreign key constraint fails",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5619": [
        "OB_ERR_QUALIFIER_EXISTS_FOR_USING_COLUMN",
        "Column part of using clause can not have qualifier",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5620": [
    ...
    "-5629": [
        "OB_ERR_YEAR_CONFLICTS_WITH_JULIAN_DATE",
        "year conflicts with Julian date",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5630": [
        "OB_ERR_DAY_OF_YEAR_CONFLICTS_WITH_JULIAN_DATE",
        "day of year conflicts with Julian date",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5631": [
        "OB_ERR_MONTH_CONFLICTS_WITH_JULIAN_DATE",
        "month conflicts with Julian date",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5632": [
        "OB_ERR_DAY_OF_MONTH_CONFLICTS_WITH_JULIAN_DATE",
        "day of month conflicts with Julian date",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5633": [
        "OB_ERR_DAY_OF_WEEK_CONFLICTS_WITH_JULIAN_DATE",
    ...
    "-5637": [
        "OB_ERR_DATE_NOT_VALID_FOR_MONTH_SPECIFIED",
        "date not valid for month specified",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5638": [
        "OB_ERR_INPUT_VALUE_NOT_LONG_ENOUGH",
        "input value not long enough for date format",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5640": [
        "OB_ERR_INVALID_QUARTER_VALUE",
        "quarter must be between 1 and 4",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5641": [
        "OB_ERR_INVALID_MONTH",
        "not a valid month",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-5648": [
        "OB_ERR_INVALID_SECONDS_IN_DAY_VALUE",
        "seconds in day must be between 0 and 86399",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5649": [
        "OB_ERR_INVALID_JULIAN_DATE_VALUE",
    ...
    "-5654": [
        "OB_ERR_SIGNED_YEAR_PRECLUDES_USE_OF_BC_AD",
        "signed year precludes use of BC/AD",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5655": [
        "OB_ERR_JULIAN_DATE_PRECLUDES_USE_OF_DAY_OF_YEAR",
        "Julian date precludes use of day of year",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5656": [
        "OB_ERR_YEAR_MAY_ONLY_BE_SPECIFIED_ONCE",
        "year may only be specified once",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5657": [
        "OB_ERR_HOUR_MAY_ONLY_BE_SPECIFIED_ONCE",
    ...
    "-5660": [
        "OB_ERR_MONTH_MAY_ONLY_BE_SPECIFIED_ONCE",
    ...
    "-5662": [
        "OB_ERR_FORMAT_CODE_CANNOT_APPEAR",
    ...
    "-5666": [
        "OB_ERR_INVALID_ESCAPE_CHAR_LENGTH",
        "escape character must be character string of length 1",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5667": [
        "OB_ERR_DAY_OF_MONTH_RANGE",
    ...
    "-5672": [
        "OB_ERR_COLUMN_LIST_ALREADY_INDEXED",
        "such column list already indexed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5673": [
        "OB_ERR_BUSHY_TREE_NOT_SUPPORTED",
        "PX does not support processing a bushy tree",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-5674": [
    ...
    "-6001": [
        ...
        "Transaction set changed during the execution",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6002": [
    ...
    "-6203": [
        "OB_MASK_SET_NO_NODE",
        "Mask set has no node",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6204": [
        "OB_TRANS_HAS_DECIDED",
    ...
    "-6206": [
        ...
        "Transaction state not changed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6207": [
        "OB_TRANS_PROTOCOL_ERROR",
        "Transaction protocol error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6208": [
        "OB_TRANS_INVALID_MESSAGE",
        "Transaction message invalid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6209": [
        "OB_TRANS_INVALID_MESSAGE_TYPE",
        "Transaction message type invalid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6210": [
    ...
    "-6212": [
        ...
        "Statement is timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6213": [
        "OB_TRANS_CTX_NOT_EXIST",
        "Transaction context does not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6214": [
        "OB_PARTITION_IS_FROZEN",
        "Partition is frozen",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6215": [
        "OB_PARTITION_IS_NOT_FROZEN",
        "Partition is not frozen",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6219": [
        "OB_TRANS_INVALID_LOG_TYPE",
        "Transaction invalid log type",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6220": [
        "OB_TRANS_SQL_SEQUENCE_ILLEGAL",
        "SQL sequence illegal",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6221": [
        "OB_TRANS_CANNOT_BE_KILLED",
        "Transaction context cannot be killed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6222": [
    ...
    "-6227": [
        "OB_PARTITION_IS_NOT_STOPPED",
        "Partition is not stopped",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6228": [
    ...
    "-6234": [
        ...
        "transaction context count reach limit",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6301": [
    ...
    "-6302": [
        "OB_LSR_THREAD_STOPPED",
        "log scan runnable thread stop",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6303": [
    ...
    "-6308": [
        ...
        "external executor handle do not finish",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6309": [
    ...
    "-6313": [
        "OB_REPLAY_EAGAIN_TOO_MUCH_TIME",
        "replay eagain cost too much time",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6314": [
        "OB_MEMBER_CHANGE_FAILED",
        "member change log sync failed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6315": [
    ...
    "-6317": [
        "OB_ALLOC_LOG_ID_NEED_RETRY",
        "alloc log id need retry",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6318": [
        "OB_TRANS_ONE_PC_NOT_ALLOWED",
        "transaction one pc not allowed",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6319": [
    ...
    "-6321": [
        ...
        "ob invalid batch size",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-6322": [
        "OB_CLOG_SLIDE_TIMEOUT",
        "ob clog slide timeout",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7000": [
        "OB_ELECTION_WARN_LOGBUF_FULL",
    ...
    "-7004": [
        "OB_ELECTION_WARN_NOT_REACH_MAJORITY",
        "Election does not reach majority",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7005": [
    ...
    "-7006": [
        "OB_ELECTION_WARN_INVALID_LEADER",
        "The leader is not valid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7007": [
        "OB_ELECTION_WARN_LEADER_LEASE_EXPIRED",
        "The leader lease is expired",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7010": [
        "OB_ELECTION_WARN_INVALID_MESSAGE",
        "The message is not valid",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7011": [
        "OB_ELECTION_WARN_MESSAGE_NOT_INTIME",
        "The message is not intime",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7012": [
        "OB_ELECTION_WARN_NOT_CANDIDATE",
        "The server is not candidate",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7013": [
        "OB_ELECTION_WARN_NOT_CANDIDATE_OR_VOTER",
        "The server is not candidate or voter",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7014": [
        "OB_ELECTION_WARN_PROTOCOL_ERROR",
    ...
    "-7015": [
        ...
        "The task run time out of range",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7021": [
        "OB_ELECTION_WARN_LAST_OPERATION_NOT_DONE",
        "Last operation has not done",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7022": [
    ...
    "-7024": [
        "OB_ELECTION_WARN_NO_PREPARE_MESSAGE",
        "There is not prepare message",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7025": [
        "OB_ELECTION_ERROR_MULTI_PREPARE_MESSAGE",
        "There is more than one prepare message",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7026": [
    ...
    "-7027": [
        "OB_ELECTION_MGR_IS_RUNNING",
        "Election manager is running",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7029": [
    ...
    "-7030": [
        ...
        "Election async log init error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7031": [
        "OB_ELECTION_WAIT_LEADER_MESSAGE",
        "Election waiting leader message",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7032": [
        "OB_ELECTION_GROUP_NOT_EXIST",
        "Election group not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7033": [
        "OB_UNEXPECT_EG_VERSION",
        "unexpected eg_version",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7034": [
        "OB_ELECTION_GROUP_MGR_IS_RUNNING",
        "election_group_mgr is running",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7035": [
        "OB_ELECTION_MGR_NOT_RUNNING",
        "Election manager is not running",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7100": [
    ...
    "-7101": [
        "OB_TOO_MANY_TRANSFER_TASK",
        "too many transfer tasks",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7102": [
        "OB_TRANSFER_TASK_EXIST",
        "transfer task exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7103": [
        "OB_TRANSFER_TASK_NOT_EXIST",
        "transfer task not exist",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7104": [
        "OB_NOT_ALLOW_TO_REMOVE",
        "not allow to remove",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7105": [
        "OB_RG_NOT_MATCH",
        "replication group not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7106": [
        "OB_TRANSFER_TASK_ABORTED",
        "transfer task aborted",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7107": [
        "OB_TRANSFER_INVALID_MESSAGE",
        "transfer invalid message",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-7108": [
        "OB_TRANSFER_CTX_TS_NOT_MATCH",
        "transfer ctx_ts not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-8001": [
    ...
    "-8002": [
        "OB_SERVER_IS_STOPPING",
        "Server is stopping",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-8003": [
        "OB_PACKET_CHECKSUM_ERROR",
    ...
    "-9007": [
        "OB_FILE_LENGTH_INVALID",
        "Invalid OSS file length",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9008": [
        "OB_NOT_READ_ALL_DATA",
        "Read all data fail",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    ...
    "-9010": [
        "OB_MD5_NOT_MATCH",
        "OSS file MD5 not match",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9011": [
        "OB_OSS_FILE_NOT_EXIST",
        "Can not find oss file",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9012": [
        "OB_OSS_DATA_VERSION_NOT_MATCHED",
        "Can not get data version from timestamp",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9013": [
        "OB_OSS_WRITE_ERROR",
        "Write OSS file error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9014": [
        "OB_RESTORE_IN_PROGRESS",
    ...
    "-9015": [
        ...
        "agent initing backup count error",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9016": [
        "OB_CLUSTER_NAME_NOT_EQUAL",
        "ob cluster name not equal",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9017": [
    ...
    "-9018": [
        ...
        "agent has failed task",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9019": [
        "OB_RESTORE_PARTITION_IS_COMPELETE",
        "restore partition is compelete",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-9020": [
        "OB_RESTORE_PARTITION_TWICE",
        "restore partition twice",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-32031": [
        "OB_ERR_CTE_ILLEGAL_QUERY_NAME",
        "illegal reference of a query name in WITH clause",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-32033": [
        "OB_ERR_CTE_UNSUPPORTED_COLUMN_ALIASING",
        "unsupported column aliasing",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-32034": [
        "OB_ERR_UNSUPPORTED_USE_OF_CTE",
    ...
    "-32039": [
        "OB_ERR_NEED_COLUMN_ALIAS_LIST_IN_RECURSIVE_CTE",
    ...
    "-32041": [
        "OB_ERR_NEED_ONLY_TWO_BRANCH_IN_RECURSIVE_CTE",
    ...
    "-32043": [
        "OB_ERR_NEED_INIT_BRANCH_IN_RECURSIVE_CTE",
    ...
    "-32481": [
        "OB_ERR_CTE_DUPLICATE_CYCLE_NON_CYCLE_VALUE",
    ...
    "-32485": [
        "OB_ERR_CTE_ILLEGAL_COLUMN_IN_CYCLE_CLAUSE",
    ...
    "-32487": [
        "OB_ERR_ILLEGAL_JOIN_IN_RECURSIVE_CTE",
        "unsupported join in recursive WITH query",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-32488": [
        "OB_ERR_CTE_NEED_COLUMN_ALIAS_LIST",
    ...
    "-976": [
        "OB_ERR_CBY_PSEUDO_COLUMN_NOT_ALLOWED",
        "Specified pseudo column or operator not allowed here",
        "Internal Error",
        "Contact OceanBase Support",
    ],
    "-1436": [
    ...
    "-30004": [
        "OB_ERR_CBY_CONNECT_BY_PATH_INVALID_SEPARATOR",
    ...
    "-30930": [
        ...
        "NOCYCLE keyword is required with CONNECT_BY_ISCYCLE pseudo column",
        "Internal Error",
        "Contact OceanBase Support",
    ],
}
