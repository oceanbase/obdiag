                ...
                with open(file, "r") as f:
                    ...
                    for package_data in package_file_data:
                        ...
                        cases_map[package_data] = {
                            "name": package_data,
                            "command": "obdiag check --{0}={1}".format(
                                package_target, package_data
                            ),
                            "info_en": package_file_data[package_data].get("info_en")
                            or "",
                            "info_cn": package_file_data[package_data].get("info_cn")
                            or "",
                        }
