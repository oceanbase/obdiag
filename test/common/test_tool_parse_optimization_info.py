...
"""
        result = StringUtils.parse_optimization_info(text=text, stdio=self.stdio, filter_tables=['game'])
...
"""
        result = StringUtils.parse_optimization_info(text=text, stdio=self.stdio, filter_tables=['chatDetail31'])
    ...
    def test_stats_info_filter_tables_none(self):
        text = """| Optimization Info:                                                                                                                                   |
| -------------------------------------                                                                                                                |
|   chatDetail31:                                                                                                                                  |
|       table_rows:51951519                                                                                                                           |
