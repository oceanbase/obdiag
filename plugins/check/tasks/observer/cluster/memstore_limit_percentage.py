...
class MemstoreLimitPercentage(TaskBase):
    ...
    def get_task_info(self):
        return {"name": "memstore_limit_percentage", "info": "Check the percentage of memory used by tenants using memstore to their total available memory. Suggest keeping the default value of 50"}
