...
"""
@time: 2024/12/29
@file: sysbench_free_test_network_speed.py
@desc: Check cluster info about network_speed for sysbench
"""
...
class SysbenchFreeTestNetworkSpeedTask(TaskBase):
    ...
    def get_task_info(self):
        return {"name": "sysbench_free_test_network_speed", "info": "Check cluster info about network_speed for sysbench."}


sysbench_free_test_network_speed = SysbenchFreeTestNetworkSpeedTask()
