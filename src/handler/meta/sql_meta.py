...
sql_dict.set_value(
    ...
    select /*+ sql_audit */ 
    trace_id,
    CONVERT(query_sql USING utf8mb4) AS query_sql,
    RETURN_ROWS,
...
sql_dict.set_value(
    ...
    'CONVERT(`QUERY_SQL` USING utf8mb4) AS `QUERY_SQL`,`PLAN_ID`,`AFFECTED_ROWS`,`RETURN_ROWS`,`PARTITION_CNT`,`RET_CODE`,`QC_ID`,`DFO_ID`,`SQC_ID`,'
