...
hardcode_scene_list = [
    ...
    RegisteredHardCodeScene(
        'observer.rollback_transaction', 'obdiag gather scene run --scene=observer.rollback_transaction --from "2025-12-22 10:00:00" --to "2025-12-22 11:00:00"', '[Rollback transaction collection]', '[回滚事务收集]'
    ),
]
