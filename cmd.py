...
class ObdiagAnalyzeParameterCommand(MajorCommand):
    ...
    def __init__(self):
        super(ObdiagAnalyzeParameterCommand, self).__init__('parameters', 'Analyze parameters info')
...
class ObdiagAnalyzeParameterNonDefaultCommand(ObdiagOriginCommand):
    ...
    def __init__(self):
        super(ObdiagAnalyzeParameterNonDefaultCommand, self).__init__('non-default', 'list non-default value')
...
class ObdiagAnalyzeParameterDiffCommand(ObdiagOriginCommand):
    ...
    def __init__(self):
        super(ObdiagAnalyzeParameterDiffCommand, self).__init__('diff', 'list inconsistent values among different observers')
        self.parser.add_option('--file', type='string', help="specify parameter file")
        self.parser.add_option('--store_dir', type='string', help='the dir to store gather result, current dir by default.', default='./')
        self.parser.add_option('-c', type='string', help='obdiag custom config', default=os.path.expanduser('~/.obdiag/config.yml'))
...
class ObdiagAnalyzeVariableCommand(ObdiagOriginCommand):
    ...
    def __init__(self):
        super(ObdiagAnalyzeVariableCommand, self).__init__('variables', 'Analyze oceanbase variable from online observer machines to offline oceanbase variable files')
        self.parser.add_option('--file', type='string', help="specify variable file")
        self.parser.add_option('--store_dir', type='string', help='the dir to store gather result, current dir by default.', default='./')
        self.parser.add_option('-c', type='string', help='obdiag custom config', default=os.path.expanduser('~/.obdiag/config.yml'))
...
class ObdiagGatherParametersCommand(ObdiagOriginCommand):

    def __init__(self):
        super(ObdiagGatherParametersCommand, self).__init__('parameters', 'Gather parameters info')
        self.parser.add_option('--store_dir', type='string', help='the dir to store gather result, current dir by default.', default='./')

        self.parser.add_option('-c', type='string', help='obdiag custom config', default=os.path.expanduser('~/.obdiag/config.yml'))

    def init(self, cmd, args):
        super(ObdiagGatherParametersCommand, self).init(cmd, args)
        return self
...
class ObdiagGatherVariablesCommand(ObdiagOriginCommand):

    def __init__(self):
        super(ObdiagGatherVariablesCommand, self).__init__('variables', 'Gather variables info')
        self.parser.add_option('--store_dir', type='string', help='the dir to store gather result, current dir by default.', default='./')

        self.parser.add_option('-c', type='string', help='obdiag custom config', default=os.path.expanduser('~/.obdiag/config.yml'))

    def init(self, cmd, args):
        super(ObdiagGatherVariablesCommand, self).init(cmd, args)
        return self
...
class ObdiagGatherCommand(MajorCommand):
    ...
    def __init__(self):
        ...
        self.register_command(ObdiagGatherParametersCommand())
        self.register_command(ObdiagGatherVariablesCommand())
